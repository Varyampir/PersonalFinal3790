...
<html lang="en">
	<head>
	<meta charset="utf-8">
	<!-- This start file was build by Paul Cheney after doing lots of research on the web -->
	<title>M6 HTML5 Form</title>
    ...
    <script src="scripts/hidebtn.js"></script>

	<!--STYLE SHEETS-->
	<link href='http://fonts.googleapis.com/css?family=Poiret+One|Sirin+Stencil|Offside|Sniglet|Cantarell' rel='stylesheet' type='text/css'>

	<link href="../css/reset.css" rel="stylesheet">
	<!-- phone-default -->
	<link href="../css/phonedef.css" rel="stylesheet">
	<!-- enhance-tablet -->
...
<div id="wrapper">
	<div id="container">	
		<header>
			<img src="../img/weblab.gif">
			<h1>Web Lab Designs</h1>
			<p>Design for Personal Learning</p>
			
			<div class="stayOpen"></div>
		</header>

		<nav>
			<button class="menuBtn" id="showPhoneNav">Menu</button>
			<ul id="myNav">
				<li><a href="#">Main</a></li>

				<!--This is the about veganism  menu-->
				...
				<!--This is the Tech menu-->
				<li><a href="#">Learning Resources</a>
					<ul>
						<li><a href="#">Online Tutorials</a></li>
						<li><a href="#">Best and Newest</a></li>
						<li><a href="#">Code Library</a></li>
					</ul>
				</li>
				<li class="active"><a href="#">Current Project</a>
				<li><a href="#">Join Us</a>
				<li><a href="#">Contact</a>
...
$my_email = "miassminstrel@gmail.com";
...
$continue = "http://dgm2740.inkedkeyboard.com/06forms/thanks.html";
...
?>
			...
			<div class="row">
				...
				<p>Your registration form has been submitted.</p>			
	    ...
	    <footer>2013 by Varvara Jones for DGM 2740.</footer>
